...
def properInfo():
	...
	print '  I1 information more detail about stock sectors.'
	print '3. Tree layout denpend on sectors.'
	print '  I2 information more detail about exchange bourse.'
	print '4. Layout Stock'
	print 'C_lear nodes'
	print 'D_elete edges'
	...
	print 'SB_subgraphs of most bought stocks.'
	print '0 Exit'
...
def play(graph):
	...
	if choice == '1':
		...
		myData = GetGraphData(graph)
		myMatrix = myData.getMatrix()
		stockLayout = StockAnalyse(graph)
		stockLayout.mostBuylayout(myMatrix)
		...
		propDict = myPropertyMatrix.getNameNodeDict()
		myPredict.addSubgraphMostBuy(propDict)
	elif choice == '0':
		print 'Thanks'
	else:
